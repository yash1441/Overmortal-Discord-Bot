...
module.exports = {
    ...
    async execute(reaction, user) {
        ...
        const response = await lark.listRecords(process.env.FEEDBACK_POOL_BASE, process.env.SUGGESTIONS_TABLE, { filter: 'AND(CurrentValue.[Title] = "' + reaction.message.channel.name + '", CurrentValue.[Discord Name] = "' + reaction.message.embeds[0].data.author.name + '")' });
